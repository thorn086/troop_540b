    ...
    render() {
        return (
            <div className="App">
                ...
                <p>***A month from June 10th's meeting, those scouts who partook in the physical training exercises will complete your second round of them for the requirement.***</p>
                    </div>
                </section>
                <Footer />
            </div>
