    ...
    return (
        <section id='significant__events'>
            ...
            <div id="event_dates">
                ...
                <h5 className='dates'> John's Eagle Project October 28th, 2021 8:00 - 1:00 PM, 4:00-8:00 PM
                        <br />
                        <a id='st_charels' target="blank" href="http://www.franklinfpc.org">
                            Faith Presbyterian Church
                        </a></h5>
                        <br />
                        <h5 className='dates'> John's Eagle Project October 29th, 2021 8:00 - 2:00 PM
                        <br />
                        <a id='st_charels' target="blank" href="http://www.franklinfpc.org">
                            Faith Presbyterian Church
                        </a></h5>
                        <br />
                        <h5 className='dates'> John's Eagle Project October 30th, 2021 8:00 - 2:00 PM
                        <br />
                        <a id='st_charels' target="blank" href="http://www.franklinfpc.org">
                            Faith Presbyterian Church
                        </a></h5>
                        <br />
                        <h5 className='dates'> Pancake Breakfast November 7th, 2021 8:00 - 1:00 PM
                        <br />
                        ...
                        <a id='st_charels' target="blank" href="https://www.signupgenius.com/go/20f0948acab2fa6ff2-pancake1">
                            Sign Up Genius
                        </a></h5>
